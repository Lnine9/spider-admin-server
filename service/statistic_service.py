    ...
    def schedule_statistics(cls, query: dict):
        ...
        for schedule in schedules:
            try:
                ...
                result.append(schedule_statistic)
            except Exception as e:
    ...
    def running_projects(cls):
        ...
        for project in projects:
            try:
                ...
                project_statistic.project_info = project
                ...
                result.append(project_statistic)
            except Exception as e:
                logging.error(f"project: {project.id} error: {e}")
